...
import com.badlogic.gdx.backends.sdl3.Sdl3Graphics.Sdl3DisplayMode;
import com.badlogic.gdx.graphics.Color;

public class Sdl3WindowConfiguration {
	int windowX = -1;
	int windowY = -1;
	int windowWidth = 640;
	...
	public void setMaximizedMonitor (Graphics.Monitor monitor) {
		this.maximizedMonitor = (Sdl3Graphics.Sdl3Monitor)monitor;
	}
	...
	/** Sets the {@link Sdl3WindowListener} which will be informed about iconficiation, focus loss and window close events. */
	public void setWindowListener (Sdl3WindowListener windowListener) {
		this.windowListener = windowListener;
	}

	/** Sets the app to use fullscreen mode. Use the static methods like {@link Sdl3ApplicationConfiguration#getDisplayMode()} on
	...
	public void setFullscreenMode (DisplayMode mode) {
		this.fullscreenMode = (Sdl3DisplayMode)mode;
	}
