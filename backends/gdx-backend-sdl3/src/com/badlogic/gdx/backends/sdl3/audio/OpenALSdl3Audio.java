...
/** @author Nathan Sweet */
public class OpenALSdl3Audio implements Sdl3Audio {
	...
	private ObjectMap<String, BiFunction<OpenALSdl3Audio, FileHandle, OpenALSound>> extensionToSoundClass = new ObjectMap<>();
	private ObjectMap<String, BiFunction<OpenALSdl3Audio, FileHandle, OpenALMusic>> extensionToMusicClass = new ObjectMap<>();
	...
	public OpenALSdl3Audio () {
		this(16, 9, 512);
	}

	public OpenALSdl3Audio (int simultaneousSources, int deviceBufferCount, int deviceBufferSize) {
	...
	public void registerSound (String extension, BiFunction<OpenALSdl3Audio, FileHandle, OpenALSound> soundSupplier) {
	...
	public void registerMusic (String extension, BiFunction<OpenALSdl3Audio, FileHandle, OpenALMusic> soundSupplier) {
		if (extension == null) throw new IllegalArgumentException("extension cannot be null.");
	...
	public OpenALSound newSound (FileHandle file, String extension) {
		...
		BiFunction<OpenALSdl3Audio, FileHandle, OpenALSound> soundSupplier = extensionToSoundClass.get(extension);
	...
	public OpenALMusic newMusic (FileHandle file) {
		if (file == null) throw new IllegalArgumentException("file cannot be null.");
		BiFunction<OpenALSdl3Audio, FileHandle, OpenALMusic> musicSupplier = extensionToMusicClass
