 ...
 * set per window via {@link Sdl3ApplicationConfiguration} and {@link Sdl3WindowConfiguration}. Close events can be canceled by
 * returning false.
 * 
 * @author badlogic */
public interface Sdl3WindowListener {

	/** Called after the SDL window is created and its OpenGL context is current on the calling thread. It is safe to call SDL
	 * functions here.
	 *
	 * For the main window, this is an immediate callback from inside
	 * {@link Sdl3Application#Sdl3Application(ApplicationListener, Sdl3ApplicationConfiguration)}.
	 *
	 * @param window the window instance
	 *
	 * @see Sdl3Application#newWindow(ApplicationListener, Sdl3WindowConfiguration) */
	void created (Sdl3Window window);
