...
public class WindowStateGateTest {
	@Test
	public void minimizeThenRestore_firesIconify () {
	...
	@Test
	public void maximizeThenRestore_firesMaximizeFalse () {
		WindowStateGate g = new WindowStateGate();
	...
	@Test
	public void maximizeThenMinimizeThenRestore_unminimizesButStaysMaximized () {
		WindowStateGate g = new WindowStateGate();
		g.onMaximized();
		g.onMinimized();
		assertEquals(Transition.ICONIFIED_FALSE, g.onRestored());
