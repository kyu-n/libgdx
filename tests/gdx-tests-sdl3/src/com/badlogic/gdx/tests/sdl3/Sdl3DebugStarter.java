...
import com.badlogic.gdx.backends.sdl3.Sdl3WindowListener;
...
public class Sdl3DebugStarter {
	public static void main (String[] argv) throws NoSuchFieldException, SecurityException, ClassNotFoundException {
			...
			public void create () {
				...
				Gdx.input.setInputProcessor(new InputAdapter() {
					...
					public boolean keyTyped (char character) {
						...
						Sdl3Window window = ((Sdl3Graphics)Gdx.graphics).getWindow();
						if (character == 'v') {
		...
		config.setWindowListener(new Sdl3WindowListener() {
			@Override
		...
		for (DisplayMode mode : Sdl3ApplicationConfiguration.getDisplayModes()) {
